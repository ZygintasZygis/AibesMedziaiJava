...
import Lab3Cegelskis.Knyga;
import Lab3Cegelskis.greitaveikosTyrimas;
import Lab3Cegelskis.knyguGamyba;
...
public class Lab3Window extends JFrame implements ActionListener {
    ...
    private SortedSetADTx<Knyga> knyguSet;
    ...
    private void heightTree(){
        KsSwing.setFormatStartOfLine(true);
//        JOptionPane.showMessageDialog(Lab3Window.this, "<" + knyguSet.height() + "> medzio aukstis.",
//                   "Aukstis", JOptionPane.WARNING_MESSAGE);
        System.out.println("Medzio aukstis: " +  " " + knyguSet.height());
    }
    
    private void treeContains(){
        KsSwing.setFormatStartOfLine(true);
        String indString = JOptionPane.showInputDialog(Lab3Window.this, "Iveskite elementa, kuri norite PATIKRINTI:  ",
                "Tekstas", JOptionPane.WARNING_MESSAGE);
        Knyga nbook = new Knyga(indString);
        String keyval = JOptionPane.showInputDialog(Lab3Window.this, "Iveskite elemento rakta: ",
                "Tekstas", JOptionPane.WARNING_MESSAGE);
        nbook.setKey(keyval);
        if(knyguSet.contains(nbook)){
            JOptionPane.showMessageDialog(Lab3Window.this, "Si knyga aibeje yra",
                   "Tikrinimas", JOptionPane.WARNING_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(Lab3Window.this, "Sios knygos aibeje nera",
                   "Tikrinimas", JOptionPane.WARNING_MESSAGE);
    ...
    public void treeGeneration(String filePath) throws MyException {
        ...
        KsSwing.setFormatStartOfLine(true);
        KsSwing.oun(taOutput, knyguSet.toVisualizedString(delimiter),
    ...
    private void treeAdd() throws MyException {
        String indString = JOptionPane.showInputDialog(Lab3Window.this, "Iveskite elementa, kuri norite prideti i aibe:  ",
                "Tekstas", JOptionPane.WARNING_MESSAGE);
        Knyga temp = new Knyga(indString);
        //Knyga knyga = knyguGamyba.gautiIsBazes();
        knyguSet.add(temp);
        panParam1.getTfOfTable().get(2).setText(String.valueOf(--sizeOfLeftSubSet));
        KsSwing.setFormatStartOfLine(true);
        KsSwing.oun(taOutput, temp, MESSAGES.getString("msg7"));
        //KsSwing.oun(taOutput, temp, MESSAGES.getString("msg7"));
        KsSwing.oun(taOutput, knyguSet.toVisualizedString(delimiter));
        KsSwing.setFormatStartOfLine(false);
    }
    ...
    private void treeRemove() {
        String indString = JOptionPane.showInputDialog(Lab3Window.this, "Iveskite elementa, kuri norite istrinti is aibes:  ",
                "Tekstas", JOptionPane.WARNING_MESSAGE);
        Knyga deleteBook = new Knyga(indString);
        KsSwing.setFormatStartOfLine(true);
        if (knyguSet.isEmpty()) {
            ...
            knyguSet.remove(deleteBook);
            KsSwing.oun(taOutput, deleteBook, MESSAGES.getString("msg6"));
            KsSwing.oun(taOutput, knyguSet.toVisualizedString(delimiter));
        }
        KsSwing.setFormatStartOfLine(false);
    }
    ...
    private void treeIteration() {
        ...
        if (knyguSet.isEmpty()) {
            ...
            KsSwing.oun(taOutput, knyguSet, MESSAGES.getString("msg8"));
        }
        KsSwing.setFormatStartOfLine(false);
    }
